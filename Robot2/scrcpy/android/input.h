...
inline android_metastate operator|(android_metastate a, android_metastate b)
{
    return static_cast<android_metastate>(static_cast<int>(a) | static_cast<int>(b));
}
inline android_metastate& operator|=(android_metastate& a, android_metastate b)
{
    return a = a | b;
...
inline android_motionevent_buttons operator|(android_motionevent_buttons a, android_motionevent_buttons b)
{
    return static_cast<android_motionevent_buttons>(static_cast<int>(a) | static_cast<int>(b));
}
inline android_motionevent_buttons& operator|=(android_motionevent_buttons& a, android_motionevent_buttons b)
{
    return a = a | b;
